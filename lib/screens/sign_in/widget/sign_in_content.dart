...
import 'package:homefit/screens/common_widgets/fitness_loading.dart';
import 'package:homefit/screens/common_widgets/fitness_text_field.dart';
import 'package:homefit/screens/sign_in/bloc/sign_in_bloc.dart';
  ...
  Widget _createSignInButton(BuildContext context) {
    ...
    return Padding(
      ...
      child: BlocBuilder<SignInBloc, SignInState>(
        buildWhen:
            (_, currState) => currState is SignInButtonEnableChangedState,
        builder: (context, state) {
          return FitnessButton(
            title: TextConstants.signIn,
            isEnabled:
                state is SignInButtonEnableChangedState
                    ? state.isEnabled
                    : false,
            onTap: () {
              FocusScope.of(context).unfocus();
    ...
    return Center(
      child: RichText(
        text: TextSpan(
          ...
          style: TextStyle(color: ColorConstants.textBlack, fontSize: 18),
          children: [
            TextSpan(
