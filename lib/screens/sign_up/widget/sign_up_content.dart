...
import 'package:homefit/screens/sign_up/bloc/signup_bloc.dart';
  ...
  Widget _createSignUpButton(BuildContext context) {
    ...
    return Padding(
      ...
      child: BlocBuilder<SignUpBloc, SignUpState>(
        buildWhen:
            (_, currState) => currState is SignUpButtonEnableChangedState,
        builder: (context, state) {
          return FitnessButton(
            title: TextConstants.signUp,
            isEnabled:
                state is SignUpButtonEnableChangedState
                    ? state.isEnabled
                    : false,
            onTap: () {
              FocusScope.of(context).unfocus();
