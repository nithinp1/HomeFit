...
import 'package:homefit/screens/start_workout/bloc/start_workout_bloc.dart';
import 'package:homefit/screens/start_workout/page/start_workout_page.dart';
import 'package:homefit/screens/start_workout/widget/start_workout_video.dart';
...
class StartWorkoutContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SafeArea(child: _createDetailedExercise(context)),
    );
  }
      ...
      onTap: () {
        if (nextExercise != null) {
          List<ExerciseData> exercisesList =
              BlocProvider.of<workout_bloc.WorkoutDetailsBloc>(
                context,
